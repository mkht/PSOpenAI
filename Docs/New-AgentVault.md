...
online version: https://github.com/mkht/PSOpenAI/blob/v5/Docs/New-AgentVault.md
schema: 2.0.0
---
...
## SYNOPSIS
Creates an agent credential vault.
...
## DESCRIPTION
Creates an agent credential vault. This command uses the OpenAI Agents API public beta and sends the required `OpenAI-Beta: agents=v1` header. Nested, evolving request schemas are accepted through `-Body` where applicable.

## EXAMPLES

### Example 1
```powershell
New-AgentVault -Body @{ name = 'Agent credentials' }
```
