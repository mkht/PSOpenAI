function Request-AudioTranslation {
    ...
    begin {
        ...
        # Get API context
        $OpenAIParameter = Get-OpenAIContext -EndpointName 'Audio.Translation' -ApiType $ApiType -AuthType $AuthType -ApiBase $ApiBase -ApiVersion $ApiVersion -ErrorAction Stop -Engine $Model
    }
